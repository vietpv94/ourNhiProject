...
export function TeamIcon({ color = "#37373b" }: ITeamIconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M14.91 17.7799C13.32 16.7199 10.69 16.7199 9.08997 17.7799C7.67997 18.7199 7.67997 20.2599 9.08997 21.1999C10.69 22.2699 13.31 22.2699 14.91 21.1999"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
